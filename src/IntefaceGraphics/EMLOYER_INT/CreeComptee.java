 ...
 * @author pc
 */
public class CreeComptee extends javax.swing.JFrame {
    private Employer e;
    private agence a;
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws StreamCorruptedException, IOException, ClassNotFoundException { 
        ...
        if(ce.isSelected()){                                          
            e.addClt(new client(jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),a), d,1);}
            else if(cp.isSelected()){                                          
                e.addClt(new client(jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),a), d,0);}
