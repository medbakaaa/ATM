 ...
 * @author pc
 */
public class CltLoginInt extends javax.swing.JFrame {
    private compte co;
    private agence a;
    private int cnt=2;
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter your PIN(tu as 3 tentation)!!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double d=this.getCompte(pin).getSolde();
        String s=String.valueOf(d);
        if(this.verifiePin(pin)){
            MenuPrinClt m=new MenuPrinClt();
            m.jTextPane1.setText(s);
            MenuPrinClt.setA(a);
            MenuPrinClt.setCo(this.getCompte(pin));
            m.setLocationRelativeTo(null);
            m.setVisible(true);
            this.setVisible(false);
        }else if(cnt>0){
                --cnt;
                jLabel1.setText("Enter your PIN("+(cnt+1)+" tentation)!!");
    ...
    public  boolean verifiePin(int pin){
        int i;
        for(i=0;i<a.getnbCompte();i++){
           if(a.getCompte(i).getPin()==pin){
                return true;
           }
        }
        if(i==a.getnbCompte()) 
    ...
    public compte getCompte(int pin){
        int x=0;
